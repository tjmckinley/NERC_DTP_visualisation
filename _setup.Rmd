...
## set knitr options
opts_chunk$set(cache = FALSE, tidy.opts = list(width.cutoff = 55), tidy = FALSE, fig.align = "center", fig.width = 5, fig.height = 5, out.width = "50%", dpi = 300, multCode = FALSE, renderTask = TRUE, renderSol = TRUE, renderInfo = TRUE, collapsible = TRUE)
