...
A PDF handout for this part of the module can be found on the ELE page or via the link [here](advis/uploadFiles/advisHANDOUT.pdf). A PDF version of the slides (not in handout form) can be found [here](advis/uploadFiles/advisSLIDES.pdf), and a HTML version (which should be compatible with screen-readers) can be found [here](advis/uploadFiles/advisSLIDES.html).

All data files needed can be downloaded from ELE, or via the link [here](advis/uploadFiles/datasetsadvis.zip).
```
