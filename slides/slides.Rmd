...
```{r, include = F}
library(knitr)
knitr::opts_chunk$set(cache = T, echo = T, fig.align = "center", fig.width = 5, fig.height = 5, resize.width = "0.9\\textwidth", resize.height = "0.9\\textwidth")
...
Today we will discuss the main concepts, and work through some (although not all) of the examples in the notes.

A PDF can be downloaded from the website, but I would encourage you to work from the HTML here.
