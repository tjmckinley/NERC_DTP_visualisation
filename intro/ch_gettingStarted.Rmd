...
> **Note**: you can also install a package from a local ZIP file. From the [CRAN](https://cran.r-project.org/) website, click on the *Packages* link, find the correct package and simply download a suitable Windows / Mac binary file as appropriate, or the 'Package Source' file (if you are on Linux, or if you have the appropriate compiler tools installed). See Figure \@ref(fig:tidyrsource) for an example of where these can be found for the `tidyr` package.
> 
...
> ```
> 
> Once you have downloaded these, you can install using:
> 
> ```{r, eval = FALSE}
