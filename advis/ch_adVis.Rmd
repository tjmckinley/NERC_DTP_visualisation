...
A PDF handout for the slides for this part of the module can be found [here](advis/uploadFiles/advisHANDOUT.pdf). A PDF version of the slides (not in handout form) and a HTML version (which should be compatible with screen-readers) can also be found via the links [here](advis/uploadFiles/advisSLIDES.pdf) and [here](advis/uploadFiles/advisSLIDES.html).

All required data files can be downloaded from [here](advis/uploadFiles/datasets_advis.zip).
```
