...
You can see here that R has returned a value of `r 10 + 5 * 3`, illustrating one of R's key features: that it can be used as an overgrown calculator, simply by entering commands into the prompt. Notice that (unlike a language such as C) you do not have to compile these commands; you simply type them into the console, hit return, and R produces an answer. R supports basic mathematical operators, such as those found in Table \@ref(tab:mathop).

```{r, mathop, echo = F}
x <- data.frame(
    Symbol = c("+", "-", "*", "/", "^", "%%", "%/%"), 
    Meaning = c("addition", "subtraction", "multiplication", "division", "to the power", "the remainder of a division (modulo)", "the integer part")
)
x$Symbol <- paste0("`", x$Symbol, "`")
kable(x, booktabs = T, align = 'cc', caption = "Basic mathematical operators")
```
