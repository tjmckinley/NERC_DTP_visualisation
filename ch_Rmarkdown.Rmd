...
> The mean speed of cars is `` `r '\x60r mean(cars$speed)\x60'` ``
...
**Note**: in the solution below I've added some further information about the study---for interest's sake.

A solution file is provided on the workshop web page.
```
...
A solution file is given on the workshop web page.
```
