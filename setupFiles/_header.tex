...
\definecolor{exeterblue}{HTML}{005eab}
...
\setbeamertemplate{frametitle}{%
  ...
  \hfill
  \raisebox{-0.9ex}{\includegraphics[height=2.5ex,keepaspectratio]{../setupFiles/_colour_logo_vector.pdf}}
  \end{beamercolorbox}%
}
...
\hypersetup{colorlinks,linkcolor=exeterblue,urlcolor=exeterblue,citecolor=exeterblue}
...
\newtcbox{\mybox}[2][exeterblue]{nobeforeafter,colframe=#1,boxrule=1pt,boxsep=0pt,arc=0pt,outer arc=0pt,left=3pt,right=3pt,top=3pt,bottom=3pt,#2}
\tcbset{colframe=exeterblue,boxrule=1pt,boxsep=0pt,arc=0pt,outer arc=0pt,left=3pt,right=3pt,top=3pt,bottom=3pt}
