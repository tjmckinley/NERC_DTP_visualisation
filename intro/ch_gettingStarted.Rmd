...
A PDF handout for this part of the module can be found on the ELE page or via the link [here](intro/uploadFiles/introHANDOUT.pdf). A PDF version of the slides (not in handout form) can be found [here](intro/uploadFiles/introSLIDES.pdf), and a HTML version (which should be compatible with screen-readers) can be found [here](intro/uploadFiles/introSLIDES.html).
